  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-16">
        <span className="inline-block bg-poke-blue/20 border border-poke-blue/40 text-poke-blue text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
          Our Story
        </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        {values.map((v) => (
          ...
          >
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-poke-blue/20 border border-poke-blue/40 text-poke-blue mb-4">
              {v.icon}
            </div>
